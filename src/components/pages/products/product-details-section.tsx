...
const ProductDetailsSection = () => {
  ...
  const [quantity, setQuantity] = useState<number>(PRODUCT.defaultQuantity);
      ...
      <div className="relative grid grid-cols-1 gap-8 md:grid-cols-2 mt-6">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-3 lg:sticky top-22 lg:h-screen">
          ...
          <div className="flex w-16 lg:flex-col gap-3 sm:w-20">
            {[
              "/local/products/1/green.webp",
              "/local/products/1/green-back.webp",
            ].map((image, index) => (
              <Thumbnail
                key={index}
                image={image}
        ...
        <div className="flex flex-col gap-4 pt-1">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-sm uppercase">{PRODUCT.unitLabel}</span>
          </div>
          ...
          <div className="mt-2 flex flex-col gap-3 sm:flex-row">
            <Button size="lg" className="lg:flex-1 rounded-full">
              Add to bag
          ...
          <Accordion defaultValue={["benefits"]}>
            <AccordionItem value="benefits" className="bg-transparent my-0">
              ...
              <AccordionContent className="text-base" panelStyle="ps-0">
                Designed with comfort and versatility in mind, this premium
                quarter-zip pullover is perfect for everyday office wear,
                corporate events, and team apparel. Its clean design and premium
                finish make it an excellent choice for showcasing your brand.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
            ...
            <AccordionItem value="features" className="bg-transparent my-0">
              ...
              <AccordionContent className="text-base" panelStyle="ps-1">
                <ul className="list-disc list-inside">
                  <li>Premium soft-touch fabric</li>
                  <li>Lightweight and breathable</li>
                  <li>Modern quarter-zip design</li>
                  <li>Comfortable regular fit</li>
                  <li>Ideal for custom logo embroidery</li>
